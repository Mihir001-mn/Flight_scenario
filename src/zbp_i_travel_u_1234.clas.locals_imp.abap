...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  DATA legacy_entity_in   TYPE /dmo/travel.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx = CORRESPONDING zsrap_travel_x_99( <entity> MAPPING FROM ENTITY ).
...
CLASS lsc_ZI_TRAVEL_U_1234 DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZI_TRAVEL_U_1234 IMPLEMENTATION.
