CLASS zcl_ce_rap_agency_7890 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_agency_range TYPE RANGE OF zrap_7890z_travel_agency_es5-agencyid.
    TYPES t_business_data TYPE TABLE OF zrap_7890z_travel_agency_es5.
...
CLASS zcl_ce_rap_agency_7890 IMPLEMENTATION.
  ...
  METHOD get_agencies.
    ...
    service_consumption_name = to_upper( 'ZSC_RAP_AGENCY_7890' ).
