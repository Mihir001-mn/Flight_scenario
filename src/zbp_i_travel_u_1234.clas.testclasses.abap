...
CLASS ltcl_integration_test DEFINITION FINAL FOR TESTING
    ...
    CLASS ltcl_integration_test IMPLEMENTATION.
     ...
     METHOD create_travel.
      ...
      DATA travels_in TYPE TABLE FOR CREATE ZI_TRAVEL_U_1234\\travel.
      ...
      MODIFY ENTITIES OF ZI_TRAVEL_U_1234
        ENTITY travel
      ...
      SELECT * FROM ZI_TRAVEL_U_1234 WHERE TravelId = @new_travel_id INTO TABLE @DATA(lt_travel)  .
    ...
    METHOD class_setup.
      cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
          i_for_entities = VALUE #( ( i_for_entity = 'zi_travel_u_1234' )
                                  ( i_for_entity = 'zi_rap_booking_u_99' ) )
                                ).
    ENDMETHOD.
