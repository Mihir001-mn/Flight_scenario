...
CLASS lhc_travel IMPLEMENTATION.
 ...
 IF has_before_image = abap_true.
       AUTHORITY-CHECK OBJECT 'ZOSTAT_88'
         ID 'ZOSTAT_99' FIELD overall_status
         ID 'ACTVT' FIELD '02'.
     ELSE.
       AUTHORITY-CHECK OBJECT 'ZOSTAT_88'
         ID 'ZOSTAT_99' DUMMY
 ...
 ENDMETHOD.
  ...
  " Read the travel status of the existing travels
    READ ENTITIES OF ZRapdatamodel99 IN LOCAL MODE
      ENTITY Travel
          ...
          update_granted = is_update_granted( has_before_image = has_before_image  overall_status = travel_before_image-overall_status ).
           IF update_granted = abap_false.
             APPEND VALUE #( %tky        = travel-%tky
                             %msg        = NEW zcm_rap_99( severity = if_abap_behv_message=>severity-error
                                                             textid   = zcm_rap_99=>unauthorized )
                           ) TO reported-travel.
           ENDIF.
  ...
  " Set the new overall status
    MODIFY ENTITIES OF ZRapdatamodel99 IN LOCAL MODE
      ENTITY Travel
         UPDATE
           FIELDS ( TravelStatus )
...
*      " Clear state messages that might exist
    ...
    DATA business_data TYPE TABLE OF zrap_7890z_travel_agency_es5.
    ...
    " Raise  for non existing and initial agencyID
**    LOOP AT travels INTO DATA(travel).
    LOOP AT travels INTO travel.
...
**      IF travel-AgencyID IS INITIAL OR NOT line_exists( agencies_db[ agency_id = travel-AgencyID ] ).
      IF travel-AgencyID IS INITIAL OR NOT line_exists( business_data[ agencyid = travel-AgencyID ] ).
        ...
        APPEND VALUE #( %tky        = travel-%tky
                        ...
                        %msg        = NEW zcm_rap_99(
                                          ...
                                          textid   = zcm_rap_99=>agency_unknown
  ...
  " Read relevant travel instance data
    ...
    " Raise  for non existing and initial customerID
    LOOP AT travels INTO DATA(travel).
      " Clear state messages that might exist
      APPEND VALUE #(  %tky        = travel-%tky
      ...
      IF travel-CustomerID IS INITIAL OR NOT line_exists( customers_db[ customer_id = travel-CustomerID ] ).
        ...
        APPEND VALUE #(  %tky        = travel-%tky
                         ...
                         %msg        = NEW zcm_rap_99(
                                           severity   = if_abap_behv_message=>severity-error
                                           textid     = zcm_rap_99=>customer_unknown
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-EndDate < travel-BeginDate.
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zcm_rap_99(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = zcm_rap_99=>date_interval
      ...
      ELSEIF travel-BeginDate < cl_abap_context_info=>get_system_date( ).
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zcm_rap_99(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = zcm_rap_99=>begin_date_before_system_date
                                                 begindate = travel-BeginDate )
